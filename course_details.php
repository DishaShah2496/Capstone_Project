					...
					<ul class="navbar-nav justify-content-center">
						...
						<li class="nav-item dropdown active">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item active" href="course_details.php">Course Details</a>
			...
			<div class="row inner_sec_info pt-md-4">
				...
				<div class="col-lg-8 single-left">
					<div class="single-left1">
						...
						<h5 class="card-title">
							<a href="course_details.php" class="text-dark">Sed ut perspiciatis unde omnis iste natus error sit facilisis erat posuere erat</a>
						</h5>
							...
							<div class="col-md-6 single-left2-left">
								<ul>
									<li class="mt-3">
										...
										<a href="course_details.php">At vero eos et accusamus iusto</a>
									</li>
									<li class="mt-3">
										<i class="fas fa-check mr-2"></i>
										<a href="course_details.php">Sed ut perspiciatis unde omnis</a>
									</li>
									<li class="mt-3">
										<i class="fas fa-check mr-2"></i>
										<a href="course_details.php">Accusantium doloremque lauda</a>
									</li>
									<li class="mt-3">
										<i class="fas fa-check mr-2"></i>
										<a href="course_details.php">Vel illum qui dolorem fugiat quo</a>
									</li>
									<li class="mt-3">
										<i class="fas fa-check mr-2"></i>
										<a href="course_details.php">Quis autem vel eum repreh</a>
									</li>
									<li class="mt-3">
										<i class="fas fa-check mr-2"></i>
										<a href="course_details.php">Neque porro quisquam est qui</a>
									</li>
								</ul>
							</div>
							<div class="col-md-6 single-left2-left">
							...
							<div class="posts-grids">
								<div class="row posts-grid mt-4">
									...
									<div class="col-lg-8 col-md-7 col-8 posts-grid-right mt-lg-0 mt-md-5 mt-sm-4">
										<h4>
											<a href="course_details.php" class="text-dark">Sed ut perspiciatis unde omni</a>
										</h4>
										<ul class="wthree_blog_events_list mt-2">
											...
											<li>
												...
												<a href="form.php" class="text-dark ml-2">- 150</a>
											</li>
										</ul>
									</div>
								</div>
								<div class="row posts-grid mt-4">
									...
									<div class="col-lg-8 col-md-7 col-8 posts-grid-right mt-lg-0 mt-md-5 mt-sm-4">
										...
										<ul class="wthree_blog_events_list mt-2">
											...
											<li>
												<i class="fas fa-dollar-sign"></i>
												<a href="form.php" class="text-dark ml-2">- 70</a>
											</li>
										</ul>
									</div>
								</div>
								<div class="row posts-grid mt-4">
									...
									<div class="col-lg-8 col-md-7 col-8 posts-grid-right mt-lg-0 mt-md-5 mt-sm-4">
										...
										<ul class="wthree_blog_events_list mt-2">
											...
											<li>
												<i class="fas fa-dollar-sign"></i>
												<a href="form.php" class="text-dark ml-2">- 300</a>
											</li>
										</ul>
									</div>
								</div>
