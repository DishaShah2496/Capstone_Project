				...
				<div class="col-lg-8 blog_section">
					<div class="card">
						...
						<div class="card-body text-center">
							...
							<h5 class="card-title">
								<a href="single.php" class="text-dark">Blog title here</a>
							</h5>
							<p class="card-text">Morbi eget dui elit. In lectus eros, convallis vel dolor vitae, semper sodales risus. Donec convallis maximus neque
								vel cursus.</p>
							<a href="single.php" class="btn btn-primary blog-button mt-3">Read More</a>
						</div>
					</div>
					<div class="card my-4">
				...
				<div class="col-lg-4 event-right mt-lg-0 mt-sm-5 mt-4">
					<div class="event-right1">
						...
						<div class="tags mt-4 p-4 border">
							...
							<ul class="mt-4">
								<li>
									<a href="single.php" class="text-dark border">Designs</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Growth</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Latest</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Price</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Tools</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Business</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Work Space</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">New Course</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Advantage</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Concepts</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Arts</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Photography</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Research</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Software</a>
								</li>
							</ul>
						</div>
					</div>
